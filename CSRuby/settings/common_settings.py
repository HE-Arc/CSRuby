"""
Django settings for CSRuby project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, "csruby_frontend_app/templates")],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'CSRuby.wsgi.application'
...
EMAIL_HOST_USER = '25cb4362dc01ed'
EMAIL_HOST_PASSWORD = '2742964123d675'
EMAIL_PORT = '2525'
